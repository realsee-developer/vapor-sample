import { Button, HStack, Mask, Text, useDimension, VStack } from '@realsee/vapor';
  ...
  >
    <VStack>
      <VStack
        ...
        padding={{ top: `${4 / 16}rem`, right: `${64 / 16}rem` }}
      >
        {arrow}
      </VStack>
      <VStack
      ...
      >
        <VStack width={`${300 / 16}rem`} align={{ horizontal: 'center' }} gap={`${40 / 16}rem`}>
          <VStack align={{ horizontal: 'center' }} gap={`${24 / 16}rem`}>
            ...
            <HStack align={{ horizontal: 'center' }} gap={`${40 / 16}rem`}>
              <VStack align={{ horizontal: 'center' }} gap={`${6 / 16}rem`}>
                <div style={{
                  width: `${44 / 16}rem`,
                  height: `${44 / 16}rem`,
